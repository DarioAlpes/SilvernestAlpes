...
from tests.testsCJM.testOrders import SKU_ID_NAME, AMOUNT_CONSUMED_NAME, LOCATION_ID_NAME, \
    ...
    MONEY_CONSUMPTIONS_NAME, ORDER_TIME_NAME, MISSING_AMOUNT_NAME, OK_OVERFLOW_STATE, \
    get_and_check_available_funds_for_amount, get_and_check_balance_for_amount, \
    get_and_check_parent_balance_for_amount, OVERFLOWN_OVERFLOW_STATE, TEMPORALLY_OVERFLOWN_OVERFLOW_STATE
...
class PersonOrdersForPackageWithAmountTopoffsViewTestCase(FlaskClientBaseTestCase):
    ID_NAME = u"id"
    ...
    TEST_AMOUNT_TOPOFF_TRANSACTION_NUMBER = "123456"
    TEST_AMOUNT_TOPOFF_TOPOFF_TIME = "20100101010101"
    ...
    def _create_amount_topoff(self, use_sku):
        self.create_new_sku()
        if use_sku:
            self.TEST_AMOUNT_TOPOFF_ID_SKU = self.expected_ids[SKU_ENTITY_NAME]
            self.TEST_AMOUNT_TOPOFF_ID_SKU_CATEGORY = None
        else:
            self.TEST_AMOUNT_TOPOFF_ID_SKU = None
            self.TEST_AMOUNT_TOPOFF_ID_SKU_CATEGORY = self.expected_ids[SKU_CATEGORY_ENTITY_NAME]
        total_consumptions = self.NUMBER_OF_ENTITIES * self.number_of_orders * self.number_of_consumptions_per_order
        self.TEST_AMOUNT_TOPOFF_AMOUNT = total_consumptions * self.AMOUNT_PER_CONSUMPTION
    ...
    def setUp(self):
        super(PersonOrdersForPackageWithAmountTopoffsViewTestCase, self).setUp()
        create_test_client(self)

        self.number_of_orders = 1
        self.number_of_consumptions_per_order = 1
        self.missing_amount = 0
        self.consumption_time_template = "2010010103010{0}"
    ...
    def test_check_available_funds_for_new_reservation_with_sku(self):
        ...
        self.expected_amount_sku = self.TEST_AMOUNT_TOPOFF_AMOUNT
    ...
    def test_check_available_funds_for_new_reservation_with_sku_and_multiple_days(self):
    ...
    def test_check_available_funds_for_full_reservation_with_sku(self):
        self.create_package_with_restricted_consumption_and_person_reservation_with_sku()
    ...
    def test_check_available_funds_for_reservation_with_excess_consumption_for_sku(self):
        self.create_package_without_restricted_consumption_and_person_reservation_with_sku()
        self.create_and_assign_orders()

        self.do_create_requests()
        self.consumption_time_template = "2010010103020{0}"
        self.create_and_assign_orders()
    ...
    def test_check_available_funds_for_reservation_with_consumption_on_non_included_sku_for_sku(self):
        self.create_package_without_restricted_consumption_and_person_reservation_with_sku()
        ...
        get_and_check_available_funds_for_amount(self)
        self.expected_amount_consumed_sku = -self.TEST_AMOUNT_TOPOFF_AMOUNT
        get_and_check_balance_for_amount(self)
        get_and_check_parent_balance_for_amount(self)

    def test_check_available_funds_for_previously_full_reservation_after_delete_for_sku(self):
        self.create_package_with_restricted_consumption_and_person_reservation_with_sku()
        self.create_and_assign_orders()
    ...
    def test_check_available_funds_and_balance_for_full_reservation_with_topoffs_after_consumptions_for_sku(self):
        self.TEST_AMOUNT_TOPOFF_TOPOFF_TIME = "20100101230101"
        self.create_package_with_restricted_consumption_and_person_reservation_with_sku()
        self.create_and_assign_orders()
        ...
        self.id_included_sku = self.expected_ids[SKU_ENTITY_NAME]
        self.expected_state_sku = TEMPORALLY_OVERFLOWN_OVERFLOW_STATE
        self.expected_amount_sku = 0
        get_and_check_available_funds_for_amount(self)
        get_and_check_balance_for_amount(self)
        get_and_check_parent_balance_for_amount(self)

    def test_check_available_funds_for_new_reservation_with_sku_category(self):
        self.create_package_with_restricted_consumption_and_person_reservation_with_sku_category()

        self.id_included_category = self.TEST_AMOUNT_TOPOFF_ID_SKU_CATEGORY
        self.expected_amount_category = self.TEST_AMOUNT_TOPOFF_AMOUNT
        get_and_check_available_funds_for_amount(self)
        get_and_check_balance_for_amount(self)
        get_and_check_parent_balance_for_amount(self)

    def test_check_available_funds_for_new_reservation_with_sku_category_and_multiple_days(self):
        self.TEST_PERSON_RESERVATION_INITIAL_DATE = "20100101010101"
        self.TEST_RESERVATION_INITIAL_DATE = "20100101010101"
        self.TEST_PERSON_RESERVATION_FINAL_DATE = "20100103010101"
        self.TEST_RESERVATION_FINAL_DATE = "20100103010101"
    ...
    def test_check_available_funds_for_full_reservation_with_sku_category(self):
        self.create_package_with_restricted_consumption_and_person_reservation_with_sku_category()
    ...
    def test_check_available_funds_for_reservation_with_excess_consumption_for_sku_category(self):
    ...
    def test_check_available_funds_for_reservation_with_consumption_on_non_included_sku_for_sku_category(self):
        self.create_package_without_restricted_consumption_and_person_reservation_with_sku_category()
    ...
    def test_check_available_funds_for_previously_full_reservation_after_delete_for_sku_category(self):
        self.create_package_without_restricted_consumption_and_person_reservation_with_sku_category()
        self.create_and_assign_orders()
    ...
    def test_check_available_funds_and_balance_for_full_reservation_with_topoffs_after_consumptions_for_sku_category(self):
        self.TEST_AMOUNT_TOPOFF_TOPOFF_TIME = "20100101230101"
        self.create_package_without_restricted_consumption_and_person_reservation_with_sku_category()
        self.create_and_assign_orders()
