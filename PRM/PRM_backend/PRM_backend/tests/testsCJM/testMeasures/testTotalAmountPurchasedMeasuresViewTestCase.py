...
class TotalAmountPurchasedMeasureViewTestCase(FlaskClientBaseTestCase):
    STARTING_ID = 1
    ...
    def setUp(self):
        super(TotalAmountPurchasedMeasureViewTestCase, self).setUp()
    ...
    def test_calculate_valid_measure_without_final_time(self):
        results = self.do_get_request("/clients/{0}/persons/{1}/measures/total-amount-purchased/"
                                      "?{2}={3}&{4}={5}"
    ...
    def test_calculate_invalid_measure_with_invalid_final_time(self):
        ...
        self.do_get_request("/clients/{0}/persons/{1}/measures/total-amount-purchased/"
                            "?{2}={3}&{4}={5}&{6}={7}"
                            .format(self.expected_ids[CLIENT_ENTITY_NAME],
                                    self.expected_ids[PERSON_ENTITY_NAME],
                                    PersonMeasures.SKU_ID_NAME,
