...
public class CssToColorHelper extends Parent
{
	...
	public Color getNamedColor(String nombre)
	{
		setStyle("-named-color: " + nombre + ";");
		applyCss();
	...
	{
		private static final CssMetaData<CssToColorHelper, Color> NAMED_COLOR = new CssMetaData<CssToColorHelper, Color>("-named-color", ColorConverter.getInstance(), DEFAULT_NAMED_COLOR)
		{
		...
		static
		{
			final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<CssMetaData<? extends Styleable, ?>>(Parent.getClassCssMetaData());
