...
public class FragmentItemEsperado extends Fragment {
    private static final String ARG_SECTION_NUMBER = "section_number";
    private RecyclerView recycler;
    private RecyclerView.LayoutManager lManager;
    public static RecyclerView.Adapter adapter;

    public static FragmentItemEsperado newInstance(Bundle bundle) {
        FragmentItemEsperado fragment = new FragmentItemEsperado();
        if (null != bundle) {
...
// Usar un administrador para LinearLayout
        ...
        adapter = new AdapterEPCItem(ObjectItem.getmListaItemEsperado());
