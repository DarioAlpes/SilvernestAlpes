...
internal class OperacionLecturaUltralightEV1MF0UL21Pruebas : OperacionUltralightEV1MF0UL21BasePruebas()
{
    ...
    @Test
    fun leer_ultralight_ev1_MF0UL21_con_contraseña_por_defecto()
    {
        operacionLectura.leer_ultralight_ev1_con_contraseña_por_defecto()
    }

    @Test
    fun leer_ultralight_ev1_MF0UL21_con_autenticacion_activada_y_contraseña_correcta()
    {
        operacionLectura.leer_ultralight_ev1_con_autenticacion_activada_y_contraseña_correcta()
    }

    @Test
    fun intentar_leer_ultralight_ev1_MF0UL21_con_autenticacion_activada_y_contraseña_incorrecta()
    {
        operacionLectura.intentar_leer_ultralight_ev1_con_autenticacion_activada_y_contraseña_incorrecta()
    }

    @Test
    fun intentar_leer_ultralight_ev1_MF0UL21_con_autenticacion_activada_y_pack_incorrecto()
    {
        operacionLectura.intentar_leer_ultralight_ev1_con_autenticacion_activada_y_pack_incorrecto()
    }

    @Test
    fun intentar_leer_ultralight_ev1_MF0UL21_con_autenticacion_activada_pero_lectura_desprotegida()
    {
        operacionLectura.intentar_leer_ultralight_ev1_con_autenticacion_activada_pero_lectura_desprotegida()
    }

    @Test
    fun intentar_leer_ultralight_ev1_MF0UL21_con_autenticacion_activada_pero_numero_de_intentos_incorrecto()
    {
        operacionLectura.intentar_leer_ultralight_ev1_con_autenticacion_activada_pero_numero_de_intentos_incorrecto()
    }

    @Test
    fun intentar_leer_ultralight_ev1_MF0UL21_con_autenticacion_activada_pero_pagina_inicial_incorrecta()
    {
