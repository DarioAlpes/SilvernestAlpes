...
@DisplayName("Entrada")
internal class EntradaPruebas
{
    @Test
    fun hace_trim_a_nombre_correctamente()
    {
        val entidadSinTrim = Entrada(
                1,
                null,
                "    Prueba    ",
                true,
    ...
    fun copiar_funciona_correctamente_con_parametros_primitivos()
    {
        ...
        val entidadCopiada = entidadInicial.copiar(nombre = "Prueba editada", precioPorDefecto = Precio(Decimal.DIEZ, 4L), codigoExterno = "aee3h3h6b63")
        val entidadEsperada = Entrada(
                1,
                null,
                "Prueba editada",
                true,
    ...
    fun copiar_con_id_funciona_correctamente()
    {
        ...
        val entidadCopiada = entidadInicial.copiarConId(56834)
        val entidadEsperada = Entrada(
                1,
                56834,
                "Prueba",
    ...
    fun no_se_permite_instanciar_con_nombre_vacio()
    {
        ...
        assertEquals(Entrada.Campos.NOMBRE, excepcion.nombreDelCampo)
