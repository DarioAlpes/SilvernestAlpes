...
internal class SkusAPIPruebas : PruebasUsandoServidorMock<SkusAPI>()
{
    companion object
    {
    ...
    private val entidadNegocio = Sku(1, 1, "Prueba", true, true, true, Precio(Decimal.DIEZ, 10), "código externo", 1, null)
    private val entidadDTO = SkuDTO(entidadNegocio)

    override fun ManejadorDePeticiones.extraerApi(): SkusAPI = apiDeSkus

    override val mockParser: ParserRespuestasRetrofit = mockConDefaultAnswer(ParserRespuestasRetrofit::class.java).also { mock ->
        doAnswer {
            it.getArgument<() -> Response<SkuDTO>>(0).invoke()
            RespuestaIndividual.Exitosa(entidadNegocio)
        }
            .`when`(mock)
            .haciaRespuestaIndividualDesdeDTO(cualquiera<() -> Response<SkuDTO>>())
        ...
        doAnswer {
            ...
            .`when`(mock)
            .haciaRespuestaIndividualColeccionDesdeDTO(cualquiera<() -> Response<List<SkuDTO>>>())
    }
    ...
    inner class Crear
    {
        ...
        fun invoca_el_metodo_de_parseo_de_respuesta_individual_dto()
        {
            ...
            verify(mockParser).haciaRespuestaIndividualDesdeDTO(cualquiera<() -> Response<SkuDTO>>())
        ...
        fun invoca_url_correcta_usa_POST()
        {
            ...
            assertEquals("/clients/$ID_CLIENTE/skus", peticionRealizada.path)
    ...
    inner class Consultar
    {
        ...
        fun invoca_el_metodo_de_parseo_de_respuesta_individual_de_una_coleccion_dto()
        {
            ...
            verify(mockParser).haciaRespuestaIndividualColeccionDesdeDTO(cualquiera<() -> Response<List<SkuDTO>>>())
            verifyNoMoreInteractions(mockParser)
        }
    ...
    inner class Actualizar
    {
        ...
        fun invoca_url_correcta_usa_PUT()
        {
            ...
            assertEquals("/clients/$ID_CLIENTE/skus/$ID_ENTIDAD", peticionRealizada.path)
    ...
    {
        private val entidadPatch = FondoDisponibleParaLaVentaDTO<Sku>(false)
