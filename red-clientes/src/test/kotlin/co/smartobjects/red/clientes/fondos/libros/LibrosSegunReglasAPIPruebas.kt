...
internal class LibrosSegunReglasAPIPruebas : PruebasUsandoServidorMock<LibrosSegunReglasAPI>()
{
    companion object
    {
    ...
    private val entidadNegocio = LibroSegunReglas(1, 1, "Prueba", 1, linkedSetOf(), linkedSetOf(), linkedSetOf())
    private val entidadDTO = LibroSegunReglasDTO(entidadNegocio)

    override fun ManejadorDePeticiones.extraerApi(): LibrosSegunReglasAPI = apiDeLibrosSegunReglas

    override val mockParser: ParserRespuestasRetrofit = mockConDefaultAnswer(ParserRespuestasRetrofit::class.java).also { mock ->
        doAnswer {
            it.getArgument<() -> Response<LibroSegunReglasDTO>>(0).invoke()
            RespuestaIndividual.Exitosa(entidadNegocio)
        }
            .`when`(mock)
            .haciaRespuestaIndividualDesdeDTO(cualquiera<() -> Response<LibroSegunReglasDTO>>())
        ...
        doAnswer {
            ...
            .`when`(mock)
            .haciaRespuestaIndividualColeccionDesdeDTO(cualquiera<() -> Response<List<LibroSegunReglasDTO>>>())
    }
    ...
    inner class Crear
    {
        ...
        fun invoca_el_metodo_de_parseo_de_respuesta_individual_dto()
        {
            ...
            verify(mockParser).haciaRespuestaIndividualDesdeDTO(cualquiera<() -> Response<LibroSegunReglasDTO>>())
        ...
        fun invoca_url_correcta_usa_POST()
        {
            ...
            assertEquals("/clients/$ID_CLIENTE/rules-books", peticionRealizada.path)
    ...
    inner class Consultar
    {
        ...
        fun invoca_el_metodo_de_parseo_de_respuesta_individual_de_una_coleccion_dto()
        {
            ...
            verify(mockParser).haciaRespuestaIndividualColeccionDesdeDTO(cualquiera<() -> Response<List<LibroSegunReglasDTO>>>())
            verifyNoMoreInteractions(mockParser)
        }
    ...
    inner class Actualizar
    {
        ...
        fun invoca_url_correcta_usa_PUT()
        {
            ...
            assertEquals("/clients/$ID_CLIENTE/rules-books/$ID_ENTIDAD", peticionRealizada.path)
