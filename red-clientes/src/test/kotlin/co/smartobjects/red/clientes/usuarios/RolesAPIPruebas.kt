...
internal class RolesAPIPruebas : PruebasUsandoServidorMock<RolesAPI>()
{
    companion object
    {
        private const val ID_ENTIDAD = "rolprueba"
    }

    private val entidadNegocio = Rol(ID_ENTIDAD, "Prueba", setOf(PermisoBack(ID_CLIENTE, "Prueba", PermisoBack.Accion.GET_TODOS)))
    private val entidadDTO = RolDTO(entidadNegocio)

    override fun ManejadorDePeticiones.extraerApi(): RolesAPI = apiDeRoles

    override val mockParser: ParserRespuestasRetrofit = mockConDefaultAnswer(ParserRespuestasRetrofit::class.java).also { mock ->
        doAnswer {
            it.getArgument<() -> Response<RolDTO>>(0).invoke()
            RespuestaIndividual.Exitosa(entidadNegocio)
        }
            .`when`(mock)
            .haciaRespuestaIndividualDesdeDTO(cualquiera<() -> Response<RolDTO>>())
        ...
        doAnswer {
            ...
            .`when`(mock)
            .haciaRespuestaIndividualColeccionDesdeDTO(cualquiera<() -> Response<List<RolDTO>>>())
    }
    ...
    inner class Crear
    {
        ...
        fun invoca_el_metodo_de_parseo_de_respuesta_individual_dto()
        {
            ...
            verify(mockParser).haciaRespuestaIndividualDesdeDTO(cualquiera<() -> Response<RolDTO>>())
        ...
        fun invoca_url_correcta_usa_POST()
        {
            ...
            assertEquals("/clients/$ID_CLIENTE/roles", peticionRealizada.path)
    ...
    inner class Consultar
    {
        ...
        fun invoca_el_metodo_de_parseo_de_respuesta_individual_de_una_coleccion_dto()
        {
            ...
            verify(mockParser).haciaRespuestaIndividualColeccionDesdeDTO(cualquiera<() -> Response<List<RolDTO>>>())
            verifyNoMoreInteractions(mockParser)
        }
    ...
    inner class Actualizar
    {
        ...
        fun invoca_url_correcta_usa_PUT()
        {
            ...
            assertEquals("/clients/$ID_CLIENTE/roles/$ID_ENTIDAD", peticionRealizada.path)
