...
public class MiAndroidDatabaseResults implements DatabaseResults
{
	...
	public MiAndroidDatabaseResults(Cursor cursor, ObjectCache objectCache, boolean cacheStore)
	{
		this.cursor = cursor;
	...
	public int findColumn(String columnName) throws SQLException
	{
		...
		else
		{
			...
			throw new SQLException("Unknown field '" + columnName + "' from the Android sqlite cursor, not in:" + Arrays
