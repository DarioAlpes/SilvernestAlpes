...
public class MiApiCompatibilityUtils
{
	private static MiApiCompatibility compatibility;
	...
	static
	{
		...
		{
			compatibility = new MiJellyBeanApiCompatibility();
		}
		else
		{
			compatibility = new MiBasicApiCompatibility();
		}
	}
	 ...
	 */
	public static MiApiCompatibility getCompatibility()
	{
