 ...
 */
public class MiAndroidConnectionSource extends BaseConnectionSource implements ConnectionSource
{

	private static final Logger logger = LoggerFactory.getLogger(MiAndroidConnectionSource.class);
	...
	public MiAndroidConnectionSource(SQLiteOpenHelper helper)
	{
		this.helper = helper;
		this.sqliteDatabase = null;
	}

	public MiAndroidConnectionSource(SQLiteDatabase sqliteDatabase)
	{
		this.helper = null;
	...
	public DatabaseConnection getReadWriteConnection(String tableName) throws SQLException
	{
		...
		if(connection == null)
		{
			...
			connection = new MiAndroidDatabaseConnection(db, true, cancelQueriesEnabled);
	...
	{
		MiAndroidConnectionSource.connectionProxyFactory = connectionProxyFactory;
	}
