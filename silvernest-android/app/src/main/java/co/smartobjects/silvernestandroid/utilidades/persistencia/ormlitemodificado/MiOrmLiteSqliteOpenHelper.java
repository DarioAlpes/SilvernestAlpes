...
public abstract class MiOrmLiteSqliteOpenHelper extends SQLiteOpenHelper
{
	protected static Logger logger = LoggerFactory.getLogger(com.j256.ormlite.android.apptools.OrmLiteSqliteOpenHelper.class);
	protected MiAndroidConnectionSource connectionSource = new MiAndroidConnectionSource(this);
	 ...
	 */
	public MiOrmLiteSqliteOpenHelper(Context context, String databaseName, SQLiteDatabase.CursorFactory factory, int databaseVersion)
	{
	 ...
	 */
	public MiOrmLiteSqliteOpenHelper(Context context, String databaseName, SQLiteDatabase.CursorFactory factory, int databaseVersion, int configFileId)
	{
	 ...
	 */
	public MiOrmLiteSqliteOpenHelper(Context context, String databaseName, SQLiteDatabase.CursorFactory factory, int databaseVersion, File configFile)
	{
	 ...
	 */
	public MiOrmLiteSqliteOpenHelper(Context context, String databaseName, SQLiteDatabase.CursorFactory factory, int databaseVersion, InputStream stream)
	{
		super(context, databaseName, factory, databaseVersion);
		if(stream == null)
		{
	...
	public final void onCreate(SQLiteDatabase db)
	{
		...
		if(conn == null)
		{
			conn = new MiAndroidDatabaseConnection(db, true, cancelQueriesEnabled);
			try
			{
