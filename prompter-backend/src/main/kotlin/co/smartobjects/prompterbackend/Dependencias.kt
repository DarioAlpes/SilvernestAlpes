...
import co.smartobjects.prompterbackend.seguridad.GeneradorLlaveNFCClienteImpl
import co.smartobjects.prompterbackend.seguridad.ManejadorSeguridad
import co.smartobjects.prompterbackend.seguridad.shiro.ManejadorSeguridadShiro
import co.smartobjects.prompterbackend.seguridad.shiro.RealmRepositorioUsuarios


internal interface Dependencias
{
    val manejadorSeguridad: ManejadorSeguridad

    val generadorLlaveNFCCliente: GeneradorLlaveNFCCliente
    ...
    val repositorioRelacionesPersonas: RepositorioRelacionesPersonas
...
internal class DependenciasImpl(_configuracionRepositorios: ConfiguracionRepositorios? = null) : Dependencias
{
    override val manejadorSeguridad: ManejadorSeguridad = ManejadorSeguridadShiro()

    override val generadorLlaveNFCCliente: GeneradorLlaveNFCCliente = GeneradorLlaveNFCClienteImpl()

    override val configuracionRepositorios: ConfiguracionRepositorios by lazy {
        _configuracionRepositorios
        ?: /*ConfiguracionPersistenciaH2EnMemoria("db_pruebas_backend")*/
        /*ConfiguracionPersistenciaPostgreSQL(
                ConfiguracionPersistenciaPostgreSQL.Config(
                        "proddb.c4ohrqambtnv.us-east-2.rds.amazonaws.com",
                        "silvernestprod",
                        "smartobjects",
                        "hrTn2b_|0\$nq"
                                                          )
        ...
        ConfiguracionPersistenciaPostgreSQL(
                ConfiguracionPersistenciaPostgreSQL.Config(
                        "devdb2.c4ohrqambtnv.us-east-2.rds.amazonaws.com",
                        "silvernestdev",
                        "smartobjectsadmin",
                        "a1234567"
                          )
...
/*ConfiguracionPersistenciaPostgreSQL(
        ConfiguracionPersistenciaPostgreSQL.Config(
                "pruebas.c4ohrqambtnv.us-east-2.rds.amazonaws.com",
                "silvernestdev",
                "smartobjectsadmin",
                "Cafam.2019"
        )
...
override val repositorioUsuarios: RepositorioUsuarios by lazy { RepositorioUsuariosSQL(configuracionRepositorios, RealmRepositorioUsuarios.hasherShiro) }
...
override val repositorioRelacionesPersonas: RepositorioRelacionesPersonas by lazy { RepositorioRelacionesPersonasSQL(configuracionRepositorios) }
...
// Repositorios que no inicializan nada
